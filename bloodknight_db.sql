...
-- 1. Entity: BLOODKIGHT ADMIN (System Administrators)
-- Must be created first as hospital table references it
...
-- 3. Entity: HOSPITAL (Healthcare Institutions)
-- Modified to support registration requests (password_hash nullable, status includes Pending/Rejected)
CREATE TABLE IF NOT EXISTS hospital (
    ...
    password_hash VARCHAR(255) NULL, -- Nullable for pending requests
    status ENUM('Pending', 'Active', 'Inactive', 'Rejected') DEFAULT 'Pending', -- Includes Pending and Rejected for registration workflow
    rejection_reason TEXT NULL, -- For rejected registration requests
    processed_at TIMESTAMP NULL, -- When request was processed
    processed_by INT NULL, -- Which admin processed the request
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Insert default BloodKnight admin (password: admin123)
-- Verified password hash for 'admin123' generated with password_hash()
INSERT INTO bk_admin (email, password_hash, full_name) 
VALUES ('bloodknight.about@gmail.com', '$2y$10$bjPj8LdSw1.FCOugboeXFe2TBh7P69ZiRo53uvwXWfv.Zq106WM6.', 'BloodKnight Admin')
ON DUPLICATE KEY UPDATE email=email;

-- ===============================================================
-- 4. TEST DATA (Optional - Comment out for production)
-- ===============================================================

-- Sample Donors
INSERT INTO donor_user (email, password_hash, full_name, ic_number, blood_type, phone_number) VALUES 
('soldier1@example.com', 'hash123', 'John Doe', '123456-12-3456', 'A+', '012-1111111'),
('soldier2@example.com', 'hash123', 'Jane Smith', '234567-23-4567', 'O-', '012-2222222'),
('sarah@example.com', 'hash123', 'Sarah Jenkins', '345678-34-5678', 'O+', '012-3333333');

-- Sample Hospitals (Sabah, Malaysia)
-- Note: These are created with status='Active' and password_hash set for testing
INSERT INTO hospital (hospital_name, hospital_address, contact_number, hospital_type, admin_name, admin_email, admin_phone, password_hash, status) VALUES 
('Queen Elizabeth Hospital', 'Lorong Bersatu, Off Jalan Damai, 88300 Kota Kinabalu, Sabah', '088-324600', 'Government Hospital', 'Dr. Ahmad Razak', 'admin@qeh.gov.my', '012-3456789', 'hash123', 'Active'),
('KPJ Sabah Specialist Hospital', 'Jalan Damai, Luyang, 88300 Kota Kinabalu, Sabah', '088-322000', 'Private Hospital', 'Dr. Siti Nurhaliza', 'admin@kpjsabah.com', '012-9999999', 'hash123', 'Active'),
('Gleneagles Kota Kinabalu', 'Block A & B, Lot 1 & 2, Off Jalan Lapangan Terbang, 88000 Kota Kinabalu, Sabah', '088-518888', 'Private Hospital', 'Dr. Lim Wei Chuan', 'admin@gleneagles-kk.com', '012-8888888', 'hash123', 'Active'),
('Sabah Women and Children Hospital', 'Likas, 88400 Kota Kinabalu, Sabah', '088-315555', 'Government Hospital', 'Dr. Rosnah Binti Ahmad', 'admin@swch.gov.my', '012-7777777', 'hash123', 'Active'),
('Tawau Hospital', 'Jalan Apas, 91000 Tawau, Sabah', '089-773333', 'Government Hospital', 'Dr. Mohd Azmi', 'admin@tawauhospital.gov.my', '012-6666666', 'hash123', 'Active'),
('Sandakan Hospital', 'Jalan Utara, 90000 Sandakan, Sabah', '089-221555', 'Government Hospital', 'Dr. James Wong', 'admin@sandakanhospital.gov.my', '012-5555555', 'hash123', 'Active'),
('Keningau Hospital', 'Jalan Hospital, 89007 Keningau, Sabah', '087-331222', 'Government Hospital', 'Dr. Mary Lim', 'admin@keningauhospital.gov.my', '012-4444444', 'hash123', 'Active');
