...
('Queen Elizabeth Hospital', 'Kota Kinabalu', 'Government', 'Dr. Ahmad', 'admin@qeh.gov.my', '$common_pass')";

if ($conn->query($sql_hospital)) {
    echo "<p style='color:green'>✔ Hospital inserted. Login: <b>admin@qeh.gov.my</b> / <b>password123</b></p>";
} else {
    echo "<p style='color:red'>✘ Hospital insert failed: " . $conn->error . "</p>";
}

// Insert a Drive (So you have something to search for)
$conn->query("INSERT INTO blood_drive (hospital_id, drive_date, start_time, end_time, location_name) VALUES (1, CURDATE() + INTERVAL 5 DAY, '09:00', '17:00', 'City Hall Ops Center')");
